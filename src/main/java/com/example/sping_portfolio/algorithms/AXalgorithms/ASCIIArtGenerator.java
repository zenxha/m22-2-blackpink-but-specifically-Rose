...
public class ASCIIArtGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println();
        artGen.printTextArt("CODE CODE CODE!", ASCIIArtGenerator.ART_SIZE_MEDIUM);
        System.out.println();

        System.out.println();
        artGen.printTextArt("SLASH SLASH SLASH!", ASCIIArtGenerator.ART_SIZE_SMALL, ASCIIArtFont.ART_FONT_MONO,"/");
        System.out.println();
